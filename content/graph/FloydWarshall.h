 ...
 * Date: 2016-12-15
 * License: CC0
 * Source: http://en.wikipedia.org/wiki/Floyd–Warshalint_algorithm
 * Description: Calculates alint-pairs shortest path in a directed graph that might have negative edge distances.
